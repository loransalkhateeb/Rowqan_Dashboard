...
function UpdateEventsOwners() {
  ...
  useEffect(() => {
    const fetchOwnerData = async () => {
      try {
        ...
        console.error("Error fetching Event owner data:", err);
        setError("Error fetching Event owner data.");
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLoading(false);
      Swal.fire({
        title: "Event Owner Updated Successfully!",
        icon: "success",
        confirmButtonText: "Okay",
      }).then(() => {
        navigate(`/eventsowners`);
      });
    } catch (err) {
      ...
      Swal.fire({
        title: "Error!",
        text: "There was an error updating the Event owner.",
        icon: "error",
...
export default UpdateEventsOwners;
