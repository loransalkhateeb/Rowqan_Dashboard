...
function EventsOwnersPage() {
  ...
  const handleDelete = async (id) => {
    ...
    if (confirmation.isConfirmed) {
      try {
        ...
        console.error("Error deleting Event owner:", error);
        Swal.fire({
          title: "Error!",
          text: "Failed to delete the Event owner.",
          icon: "error",
        });
      }
    }
  ...
  return (
    <div className="container">
      <h1>Events Owners</h1>
      <p>Manage event owners in your system</p>
      <div className="search-container">
        <input
          type="text"
          value={searchTerm}
          onChange={handleSearchChange}
          placeholder="Search Event Owners..."
          className="search-input"
        />
      </div>
      <div className="list-owners">
        <h3>List of Event Owners</h3>
                  ...
                  <tr key={owner.id}>
                    ...
                    <td>
                      <button
                        ...
                        onClick={() =>
                          navigate(`/updateventsowners/${owner.id}`)
                        }
                      >
